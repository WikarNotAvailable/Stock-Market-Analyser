...
from src.controllers.stock_market_controller import construct_stock_market_controller
...
app.register_blueprint(construct_stock_market_controller(get_engine_from_settings()))
